...
# Added settings for NECKFLIX
_C.TRAIN.DATA.PREPROCESS.USE_BIGSMALL = False
_C.TRAIN.DATA.PREPROCESS.NECKFLIX = CN()
_C.TRAIN.DATA.PREPROCESS.NECKFLIX.CAMERA_MODE = 'RGB'
_C.TRAIN.DATA.PREPROCESS.NECKFLIX.STEREO_MODE = False
_C.TRAIN.DATA.PREPROCESS.NECKFLIX.LABELS = ['ECG']
_C.TRAIN.DATA.PREPROCESS.NECKFLIX.CVP_NORMALIZATION = [-30, 40]
_C.TRAIN.DATA.PREPROCESS.NECKFLIX.ABP_NORMALIZATION = [-50, 200]
...
# Added settings for NECKFLIX
_C.VALID.DATA.PREPROCESS.USE_BIGSMALL = False
_C.VALID.DATA.PREPROCESS.NECKFLIX = CN()
_C.VALID.DATA.PREPROCESS.NECKFLIX.CAMERA_MODE = 'RGB'
_C.VALID.DATA.PREPROCESS.NECKFLIX.STEREO_MODE = False
_C.VALID.DATA.PREPROCESS.NECKFLIX.LABELS = ['ECG']
_C.VALID.DATA.PREPROCESS.NECKFLIX.CVP_NORMALIZATION = [-30, 40]
_C.VALID.DATA.PREPROCESS.NECKFLIX.ABP_NORMALIZATION = [-50, 200]
...
# Added settings for NECKFLIX
_C.TEST.DATA.PREPROCESS.USE_BIGSMALL = False
_C.TEST.DATA.PREPROCESS.NECKFLIX = CN()
_C.TEST.DATA.PREPROCESS.NECKFLIX.CAMERA_MODE = 'RGB'
_C.TEST.DATA.PREPROCESS.NECKFLIX.STEREO_MODE = False
_C.TEST.DATA.PREPROCESS.NECKFLIX.LABELS = ['ECG']
_C.TEST.DATA.PREPROCESS.NECKFLIX.CVP_NORMALIZATION = [-30, 40]
_C.TEST.DATA.PREPROCESS.NECKFLIX.ABP_NORMALIZATION = [-50, 200]

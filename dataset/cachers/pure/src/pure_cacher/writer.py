...
#: PURE's published camera rate. Measured rates run 29.85-30.0; the
#: contract's ``fps`` attr is the nominal identity, and the per-recording
#: measured rate is kept in the root attrs.

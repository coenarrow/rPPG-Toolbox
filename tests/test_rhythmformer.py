...
INTERFACE = "configs/interfaces/rhythmformer_interface.yaml"


def test_rhythmformer_forward_matches_the_contract():
    interface = load_interface(INTERFACE)
    model = build_model(load_model_config("rhythmformer", interface), interface)

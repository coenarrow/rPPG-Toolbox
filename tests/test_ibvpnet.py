...
INTERFACE = "configs/interfaces/ibvpnet_interface.yaml"


def test_ibvpnet_forward_matches_the_contract():
    interface = load_interface(INTERFACE)
    model = build_model(load_model_config("ibvpnet", interface), interface)

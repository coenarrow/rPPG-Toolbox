...
INTERFACE = "configs/interfaces/efficientphys_interface.yaml"


def test_efficientphys_forward_matches_the_contract():
    interface = load_interface(INTERFACE)
    model = build_model(load_model_config("efficientphys", interface), interface)

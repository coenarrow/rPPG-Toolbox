...
INTERFACE = "configs/interfaces/bigsmall_interface.yaml"


def test_bigsmall_forward_matches_the_contract():
    interface = load_interface(INTERFACE)
    model = build_model(load_model_config("bigsmall", interface), interface)

...
INTERFACE = "configs/interfaces/tscan_interface.yaml"


def test_tscan_forward_matches_the_contract():
    interface = load_interface(INTERFACE)
    model = build_model(load_model_config("tscan", interface), interface)

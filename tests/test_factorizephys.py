...
INTERFACE = "configs/interfaces/factorizephys_interface.yaml"


def test_factorizephys_forward_matches_the_contract():
    interface = load_interface(INTERFACE)
    model = build_model(load_model_config("factorizephys", interface), interface)
